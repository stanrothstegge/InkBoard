    ...
    protected void updateItem(SearchResult searchResult, boolean empty) {
        ...
        if (empty || searchResult == null) {
            ...
            if (mLLoader == null) {
                ...
                mLLoader = new FXMLLoader(getClass().getResource("/fx/view/ListUtil/searchResultCell.fxml"));
                ...
                verderButton.setOnMouseClicked((event) -> {
                    try {
                        ...
                        fxmlLoader.setLocation(getClass().getResource("/fx/view/UI/courseMain.fxml"));
